  ...
  return (
    <div>
      <main className="px-5">
        <div>
          <div className="mt-12">
            <h1 className="font-bold text-3xl text-center text-purple-700">
              🍟🍔🥤 Maxi BOX
            </h1>
            <div className="mt-8">
                          ...
                          <div className="relative">
                            {!food.showCounter ? (
                              ...
                              <div className="flex items-center">
                                ...
                                <button
                                  className="bg-purple-700 text-white rounded-r-full w-8 h-8 flex items-center justify-center hover:bg-purple-800 transition-colors duration-300"
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    increment(food.id);
                                  }}
