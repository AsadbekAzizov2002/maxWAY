  ...
  return (
    <div>
      <main className="px-5 mb-10">
        <div>
          <div className="mt-12">
            <h1 className="font-bold text-3xl  ">🍰Desertlar</h1>
            <div className="mt-8">
...
//       <main>
//         <div>
//           <h1 className="px-5 mt-[69px] font-bold text-2xl">🍰Desertlar</h1>
