  ...
  return (
    <div>
      <main className="px-5 mb-10">
        <div>
          <div className="mt-12">
            <h1 className="font-bold text-3xl  ">🍚Tamaddilar</h1>
            <div className="mt-8">
...
export default Tamaddi;

// const Tamaddi = () => {
//   // State to store the list of food items
//   const [fasfood, setFasfood] = useState([]);

//   // State to manage the counter for each item
//   const [count, setCount] = useState(1);

//   // State to manage the visibility of the counter
...
//     <div>
//       <div>
//         <h1 className="px-5 mt-[69px] font-bold text-2xl">🍚Tamaddilar</h1>
...
//                   alt=""
//                 />
//                 <h2 className="px-4 pt-3 font-semibold">{food.productName}</h2>
